<template>
  <div class="wrap">
    ...
    <div class="container">
      ...
      <div class="GoodLists"
           id="GoodLists">
        <div class="GoodListsCenterScroll"
             scroll-y>
          <div class="GoodListsCenter"
               v-for="(item, index) in productList"
               :key="index">
            <div class="GoodImage">
              <img :src="'https://image.supconit.net' + '/' + item.cover.split(',')[0]"
                   alt />
            </div>
            <div class="GoodName"
                 :title="item.name">
              <div v-for="(saleItem, index) in item.saleList"
                   v-for-item="saleItem"
                   :key="index">
                <span class="sale_logo"
                      v-if="saleItem.type==0">
              ...
              <div class="manjian"
                   ...
                   v-for-item="saleItem"
                   :key="index">
                <div class="manjianInside"
                     style="line-height:13px;"
                     v-if="saleItem.type==1">满减</div>
              </div>
            </div>
            <!-- <div v-if="type == '2'">
      ...
      <van-popup v-model="showPop"
            ...
            <div style="background:#F5F5F5;font-size: 0.42rem; ">
              <div class="layout-flex row"
                ...
                <span class="date-week"
                  ...
                  <span v-if="item ==='日' || item ==='六'"
                        class="week"
                        v-bind:style="{color: weekColor}">{{item}}</span>
                </span>
              </div>
            </div>
            <div class="layout-flex row"
                 style="flex-wrap: wrap;margin-top:0.42rem;">
              <div class="date-day"
                ...
                <div class="item-days">
                  ...
                  <div class="amount"
                       v-if="item.day>0">{{item.amount}}</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="CollectionAndReserve"
             v-if="!loading">
          <div class="goHistoryRoute"
               @click="goBack"
               v-bind:style="{color: weekColor}">
          ...
          <div class="Reserve">
            <button @click="SureBuy()"
                    v-bind:style="{background: weekColor}">
    ...
    <!--返回按钮-->
    <button class="beback-btn"
            v-bind:style="{background: weekColor}"
            @click="beback"><span>返回</span></button>
  </div>
</template>
<script>
