<template>
  <div class="wrap">
    <div class="container">
      ...
      <div class='top-serach'>
        ...
        <div class='screening-condition-wrap' id="screening-condition-wrap">
          <div class='screening-item  ' :class="comprehensiveArrow?'active':''"
               @click.stop='comprehensiveConditionsChange'>
            综合
      ...
      <div class='screening-item-mun' :style='{height:height}' @click.stop='moreConditionsHide'
  ...
  export default {
    ...
    methods: {
      ...
      getRecodes() {
        ...
        http.get('/search/aptitude?type=1&size=8&page=' + page).then(res => {
