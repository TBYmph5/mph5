      ...
      <div class="page">
        ...
        <div class="comment-area">
          ...
          <div class="text-area-wrap">
            <textarea placeholder="请发表你的游记体验"  placeholder-style="font-size:26rpx;color:rgba(153,153,153,1);line-height:30rpx;letter-space:1px;" v-model="comment"  />
            <div class="words-number">{{comment.length}}/100</div>
          </div>
